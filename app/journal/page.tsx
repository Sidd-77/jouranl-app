...
export default function JournalPage() {
    ...
    const activeSave = useRef<{ date: string; promise: Promise<void> } | null>(null)
    ...
    const handleDateSelect = useCallback(async (newDate: string) => {
    ...
    }, [currentEntry.isDirty, currentEntry.isSaving, currentEntry.content, selectedDate, saveEntry])
    ...
    }, [selectedDate, currentEntry, saveEntry])
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {!currentEntry.isDirty && currentEntry.lastSavedAt && (
                            <div className="text-sm text-gray-500">
                                Last saved at {format(new Date(currentEntry.lastSavedAt), 'HH:mm:ss')}
                            </div>
                        )}
                    </div>
                    <div className="flex items-center gap-4">
